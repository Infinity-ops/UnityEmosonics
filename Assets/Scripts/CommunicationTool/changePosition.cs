 	...
 	public void change() {
		...
		if(this.name.EndsWith("2")) {
			if (GameControl.control.favorite2Pos != new Vector3()) {
                GameObject.Find("Wheel").GetComponent<CommunicationWheel>().Color = GameControl.control.favorite2Color;
		...
		if(this.name.EndsWith("3")) {
			if (GameControl.control.favorite3Pos != new Vector3()) {
                GameObject.Find("Wheel").GetComponent<CommunicationWheel>().Color = GameControl.control.favorite3Color;
		...
		if(this.name.EndsWith("4")) {
			if (GameControl.control.favorite4Pos != new Vector3()) {
                GameObject.Find("Wheel").GetComponent<CommunicationWheel>().Color = GameControl.control.favorite4Color;
